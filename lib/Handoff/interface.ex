defmodule Hordetest.Handoff do
  @callback init(options :: Keyword.t()) :: {:ok, options :: Keyword.t()}

  defmacro __using__(_opts) do
    quote do
      @behaviour Hordetest.Handoff
      ...
      def start_link(options) do
        Hordetest.Handoff.start_link(Keyword.put(options, :init_module, __MODULE__))
      end
    end
  end
  ...
  def start_link(options) do
    ...
    Supervisor.start_link(Hordetest.Handoff.Supervisor, options, name: :"#{root_name}.Supervisor")
  end
